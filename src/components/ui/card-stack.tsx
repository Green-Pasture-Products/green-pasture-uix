						...
						{items.map((item, i) => {
							...
							return (
								<motion.div
									...
									{...dragProps}
								>
									{/* translateZ lives on a child so framer keeps ownership of the animated transform */}
		...
		<div className="relative h-full w-full">
			...
			<div className="absolute inset-0">
				{item.imageSrc ? (
					...
					<div className="bg-secondary text-muted-foreground flex h-full w-full items-center justify-center text-sm">No image</div>
				)}
			</div>
