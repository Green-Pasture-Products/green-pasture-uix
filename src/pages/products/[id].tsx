					...
					{activeTab === "description" && (
						<div className="prose max-w-none">
							...
							<p className="text-gray-700 mb-6 leading-relaxed">
								{product.description} Our {product.name.toLowerCase()}{" "}
								is carefully selected from certified organic farms that
								follow sustainable farming practices. Each item is
								hand-picked at peak ripeness to ensure maximum flavor
							...
							<p className="text-gray-700 mb-6">
								...
								For best freshness, consume within 7-10 days of
								delivery. Refrigeration recommended for extended
								freshness.
							</p>
							...
							<p className="text-gray-700">
								Sourced from certified organic farms in California's
								Central Valley, known for their ideal growing conditions
								...
								<div className="grid grid-cols-2 gap-4">
									...
									<div>
										...
										<ul className="space-y-2 text-sm">
											<li className="flex justify-between">
												<span>Vitamin K</span>
												<span className="font-medium">26% DV</span>
											</li>
											<li className="flex justify-between">
												<span>Folate</span>
												<span className="font-medium">20% DV</span>
											</li>
											<li className="flex justify-between">
												<span>Potassium</span>
												<span className="font-medium">14% DV</span>
											</li>
											<li className="flex justify-between">
												<span>Vitamin E</span>
								...
								<div className="mt-4 p-3 bg-blue-50 rounded-md">
									<div className="flex items-start space-x-2">
										...
										<p className="text-sm text-blue-800">
											...
											based on growing conditions and ripeness.
										</p>
									</div>
								</div>
							</div>
