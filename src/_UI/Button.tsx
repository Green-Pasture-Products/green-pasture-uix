...
const variantStyles: Record<string, Record<string, string>> = {
	primary: {
		filled:
			"bg-primary-600 text-white shadow-elevation-1 hover:bg-gradient-to-r hover:from-primary-700 hover:via-primary-600 hover:to-lime-600 hover:shadow-[0_0_18px_rgba(154,202,60,0.5)] active:bg-primary-800 active:bg-none active:shadow-elevation-1",
		outlined:
